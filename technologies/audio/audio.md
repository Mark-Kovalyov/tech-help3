...
card 2: Generic [HD-Audio Generic], device 0: ALC887-VD Analog [ALC887-VD Analog]
  Subdevices: 1/1
  Subdevice #0: subdevice #0
card 2: Generic [HD-Audio Generic], device 2: ALC887-VD Alt Analog [ALC887-VD Alt Analog]
  Subdevices: 1/1
  Subdevice #0: subdevice #0
```
```
arecord --device="ALC887-VD Analog" --file-type=wav -f S16_LE -c2 -r44100 out.wav
```
(this is write silence! how to peek device?)
